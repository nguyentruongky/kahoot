      ...
      {showResults ? (
        <div className="relative z-10 flex min-h-screen overflow-hidden flex-col px-6 pt-6 pb-16">
          ...
          {(() => {
                    ...
                    <div className="mt-12 space-y-3">
                      {rows.map((p) => (
                        <div
                          ...
                          className={`flex h-20 items-center justify-between rounded-xl px-6 shadow-2xl ring-1 ring-black/10 ${
                            "__placeholder" in p
                        ...
                        >
                          <div className="flex items-center gap-5">
                            <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gray-100 text-2xl ring-1 ring-black/5">
                              {"__placeholder" in p
                                ? "👤"
            ...
            return (
              <>
                <div className="flex min-h-0 flex-1 items-end justify-center pb-2 pt-24">
                ...
                <div className="mt-8 grid flex-none grid-cols-2 gap-0 overflow-hidden rounded-xl shadow-2xl ring-1 ring-white/10">
                  {options.map((opt, idx) => {
